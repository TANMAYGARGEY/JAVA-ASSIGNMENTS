...
public class VectorMain
{
    public static void main(String args[])
    {
        try{
            ...
            VectorClass v4= new VectorClass (new double[]{3.0,2.0,1.0});
            VectorClass v5= new VectorClass (new double[]{9.0,6.0,7.0});
            VectorClass v6= new VectorClass (new double[]{5.0,9.0,10.0});
            System.out.println();
            ...
            System.out.println("THE dot product of v4 and v6 is: "+pro2);
            System.out.println();
        ...
        try {
            VectorClass v7= new VectorClass (new double[]{2.0,3.0,4.0});
            VectorClass v8= new VectorClass (new double[]{8.0,10.0});
            System.out.println();
